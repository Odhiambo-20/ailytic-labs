...
public class MpesaConfig {
    ...
    public String getAuthUrl() {
        return sandbox ? "https://sandbox.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials"
                      : "https://api.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials";
    }

    public String getStkPushUrl() {
        return sandbox ? "https://sandbox.safaricom.co.ke/mpesa/stkpush/v1/processrequest"
                      : "https://api.safaricom.co.ke/mpesa/stkpush/v1/processrequest";
    }

    public String getQueryUrl() {
        return sandbox ? "https://sandbox.safaricom.co.ke/mpesa/stkpushquery/v1/query"
                      : "https://api.safaricom.co.ke/mpesa/stkpushquery/v1/query";
    }

    public String getRegisterUrlEndpoint() {
        return sandbox ? "https://sandbox.safaricom.co.ke/mpesa/c2b/v1/registerurl"
    ...
    public String getBalanceUrl() {
        return sandbox ? "https://sandbox.safaricom.co.ke/mpesa/accountbalance/v1/query"
                      : "https://api.safaricom.co.ke/mpesa/accountbalance/v1/query";
    }

    public String getReversalUrl() {
        return sandbox ? "https://sandbox.safaricom.co.ke/mpesa/reversal/v1/request"
