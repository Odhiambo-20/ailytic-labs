...
import com.bellatechnologies.backend.config.MpesaConfig;
...
import com.bellatechnologies.backend.repository.MpesaPaymentRepository;
...
public class MpesaService {
    ...
    private String getAccessToken() {
        ...
        try {
            ...
            // Token expires in seconds, set expiry to 50 minutes from now
            ...
            throw new PaymentException("Failed to obtain access token: " + e.getMessage());
        }
    }
    ...
    private String formatPhoneNumber(String phoneNumber) {
        if (phoneNumber == null || phoneNumber.isEmpty()) {
            throw new PaymentException("Phone number is required");
        }
