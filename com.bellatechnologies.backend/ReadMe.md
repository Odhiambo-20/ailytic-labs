# 🚀 Bella Technologies Backend - Complete Setup Guide

A production-ready Spring Boot REST API backend for Bella Technologies, featuring AWS DynamoDB integration, Spring Security authentication, and comprehensive CRUD operations for Robots, Drones, Solar Panels, Contacts, and Newsletter management.
...
```bash
git clone https://github.com/yourusername/bellatechnologies-backend.git
cd bellatechnologies-backend
```
...
logging.level.com.bellatechnologies=DEBUG
```
...
logging.level.com.bellatechnologies=INFO
```
...
- **Email:** support@bellatechnologies.com
- **GitHub Issues:** https://github.com/yourusername/bellatechnologies-backend/issues

---

## 📄 License

Copyright © 2025 Bella Technologies. All rights reserved.

---

**🎉 Congratulations! Your Bella Technologies Backend is now ready for production!**
...
# Bella Technologies Backend - AWS Elastic Beanstalk
...
**Backend URL**: `http://bella-technologies-prod.eba-pukad2pd.us-east-1.elasticbeanstalk.com`
...
```bash
git clone https://github.com/Odhiambo-20/bella-technologies.git
cd bella-technologies/com.bellatechnologies.backend
```
...
**Expected Output**:
```
Environment details for: bella-technologies-prod
  Application name: bella-technologies-backend
  Region: us-east-1
  Deployed Version: app-XXXXXXXXX
  Platform: Corretto 17 running on 64bit Amazon Linux 2023
  Status: Ready
  Health: Green
  CNAME: bella-technologies-prod.eba-pukad2pd.us-east-1.elasticbeanstalk.com
```
...
# Test API endpoint
curl http://bella-technologies-prod.eba-pukad2pd.us-east-1.elasticbeanstalk.com/api/v1/auth/login
```
...
### Base URL
```
http://bella-technologies-prod.eba-pukad2pd.us-east-1.elasticbeanstalk.com/api/v1
```

### 1. Register a New User

```bash
curl -X POST http://bella-technologies-prod.eba-pukad2pd.us-east-1.elasticbeanstalk.com/api/v1/auth/register \
  -H "Content-Type: application/json" \
  -d '{
    "username": "testuser",
    "email": "test@test.com",
...
```bash
curl -X POST http://bella-technologies-prod.eba-pukad2pd.us-east-1.elasticbeanstalk.com/api/v1/auth/login \
  -H "Content-Type: application/json" \
  -d '{
...
curl -X GET http://bella-technologies-prod.eba-pukad2pd.us-east-1.elasticbeanstalk.com/api/v1/drones \
...
```bash
curl -X POST http://bella-technologies-prod.eba-pukad2pd.us-east-1.elasticbeanstalk.com/api/v1/payments/mpesa/stkpush \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
  -d '{
    "userId": "user-uuid",
...
```bash
curl -X POST http://bella-technologies-prod.eba-pukad2pd.us-east-1.elasticbeanstalk.com/api/v1/payments/stripe/create-intent \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
  -d '{
    "userId": "user-uuid",
...
```bash
curl -X POST http://bella-technologies-prod.eba-pukad2pd.us-east-1.elasticbeanstalk.com/api/v1/newsletter \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X POST http://bella-technologies-prod.eba-pukad2pd.us-east-1.elasticbeanstalk.com/api/v1/contact \
  -H "Content-Type: application/json" \
  -d '{
    "name": "John Doe",
    "email": "john@test.com",
...
# AWS Console → CloudWatch → Logs → /aws/elasticbeanstalk/bella-technologies-prod
```
...
- `https://bellatechnologies-frontend.vercel.app`
...
eb terminate bella-technologies-prod

# Recreate when needed
eb create bella-technologies-prod --single
```
...
- **GitHub**: [https://github.com/Odhiambo-20/bella-technologies](https://github.com/Odhiambo-20/bella-technologies)
...
**Version**: 1.0.0  
**Author**: Bella Technologies Team
