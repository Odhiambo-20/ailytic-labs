...
cp -r backup/service/* src/main/java/com/allyticlabs/backend/service/
cp -r backup/repository/* src/main/java/com/allyticlabs/backend/repository/
cp -r backup/config/* src/main/java/com/allyticlabs/backend/config/
